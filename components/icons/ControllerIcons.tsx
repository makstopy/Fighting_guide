...
export function ArcadeButton({ label, size = 28 }: { label: string; size?: number }) {
  const ARCADE_DOT_MAP: Record<string, number[]> = {
    ...
    "LK": [0, 0, 1, 0], "MK": [0, 0, 0, 1], "HK": [0, 0, 0, 1], "RK": [0, 0, 0, 1],
    "LP+HP": [1, 1, 0, 0], "LP+RP": [1, 1, 0, 0],
    "LK+HK": [0, 0, 1, 1], "LK+RK": [0, 0, 1, 1],
    "HP+LK": [0, 1, 1, 0], "RP+LK": [0, 1, 1, 0],
    "LP+LK": [1, 0, 1, 0],
    "HP+HK": [0, 1, 0, 1], "RP+RK": [0, 1, 0, 1],
    "LP+HK": [1, 0, 0, 1], "LP+RK": [1, 0, 0, 1],
    "ALL": [1, 1, 1, 1],
  };
